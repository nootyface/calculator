...
Addition=Button(cal, padx=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='+', command=lambda:btnClick('+'), bg='powder blue').grid(row=1, column=3)
...
Subtraction=Button(cal, padx=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='-', command=lambda:btnClick('-'), bg='powder blue').grid(row=2, column=3)
...
Multiplication=Button(cal, padx=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='*', command=lambda:btnClick('*'), bg='powder blue').grid(row=3, column=3)
...
btn2Clear=Button(cal, padx=16, pady=16, bd=8, fg='black', font=('arial', 20, 'bold'), text='C', command=lambda:btnClearDisplay(), bg='powder blue').grid(row=4, column=1)
